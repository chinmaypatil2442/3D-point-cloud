...
Original file is located at
    https://colab.research.google.com/drive/1aIAMBVTiFq6RW9_12N5PnlFTzqTxukjg
"""
...
!python "PointNetLK-master/experiments/train_classifier.py" -o "model1.pth" -i "input_datasets" -c "category.txt"

# Commented out IPython magic to ensure Python compatibility.
# %%writefile train_pointlk.py
# """
...
!python "PointNetLK-master/experiments/train_pointlk.py" -o "model2.pth" -i "input_datasets" -c "category.txt" --transfer-from "model1.pth_feat_best.pth" --epochs 5 --max-iter 1 --delta 0.01